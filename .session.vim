...
set helplang=en
set hidden
set keywordprg=~/.vim/scripts/php-documentation.php
set laststatus=2
set nomodeline
set mouse=a
...
silent only
cd /var/www/erpi_develme_com/vendor/develme/podio-4-laravel
if expand('%') == '' && !&modified && line('$') <= 1 && getline(1) == ''
  let s:wipebuf = bufnr('%')
endif
set shortmess=aoO
badd +10 composer.json
badd +25 src/Podio.php
badd +23 src/PodioServiceProvider.php
badd +3 src/Contracts/SessionManager.php
badd +58 src/SessionManager.php
silent! argdel *
...
nnoremap <buffer> <silent>  :call nerdtree#ui_glue#invokeKeyMap("<ENTER>")
